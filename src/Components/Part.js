...
<div className='bg-zinc-200 w-full relative bottom-0 py-4 px-4'>
<p className='text-zinc-600 text-center text-sm lg:text-lg'>copyright © | All rights Reserved 2023 </p>
